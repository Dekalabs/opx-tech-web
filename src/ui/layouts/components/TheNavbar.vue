...
<template>
  <header>
    <h1 class="text-2xl">{{ t('general.welcome') }} template-clean-vite-vue3 ✌️</h1>

    <nav>
      <RouterLink :to="{ name: 'home' }">{{ t('controlPanel.menu') }}</RouterLink>
      <RouterLink :to="{ name: 'statistics' }">{{ t('statistics.menu') }}</RouterLink>
