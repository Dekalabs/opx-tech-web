...
- [Infrastructure layer](src/infraestructure/README.md): `src/infra`
  - [`api`](src/infraestructure/api/README.md)
  - [`http`](src/infraestructure/http/README.md)
  - [`services`](src/infraestructure/services/README.md)
  - [`transformers`](src/infraestructure/transformers/README.md)
